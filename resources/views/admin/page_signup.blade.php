        ...
        <main>
            <div class="container px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Edit signup Page</li>
                </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <form action="{{ route('admin_page_signup_update') }}" method="post"
                                ...
                                <div class="card mb-4">
                                    <div class="card-header">signup Page Information</div>
                                    <div class="card-body">

                                        <!-- Form Group (username)-->
                                        <div class="mb-3">
                                            <label class="small mb-1" for="inputHeading">Heading *</label>
                                            <input name="signup_heading" class="form-control" id="inputHeading" type="text"
                                                placeholder="About-Heading" value="{{ $page_data->signup_heading }}">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="signup_status" class="form-control">
                                                <option value="1" @if ($page_data->signup_status == 1) selected @endif>
                                                    Show</option>
                                                <option value="0" @if ($page_data->signup_status == 0) selected @endif>
                                                    Hide</option>
                                            </select>
                                        </div>
                                        <!-- Save changes button-->
