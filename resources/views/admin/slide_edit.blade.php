                                ...
                                <form action="{{ route('admin_slide_update', $slide_data->id) }}" method="post"
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <img class="img-account-profile rounded-circle mb-2"
                                            src="{{ asset('upload/' . $slide_data->photo) }}" alt="" width="250"
                                            height="250">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="heading" class="form-control" id="inputHeading" type="text"
                                            placeholder="Heading" value="{{ $slide_data->heading }}">
                                    </div>
                                    <!-- Form Group (email address)-->
                                    <div class="mb-3">
                                        <label class="small mb-1" for="inputText">Text *</label>
                                        <textarea class="form-control" name="text" id="InputButtontext" rows="3">{{ $slide_data->text }}</textarea>
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" name="button_text" id="InputButtontext"
                                                type="text" placeholder="Buttontext"
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" name="button_url" id="InputButtonURL" type="text"
                                                placeholder="ButtonURl" value="{{ $slide_data->button_url }}">
                                        </div>
                                    </div>
                                    <!-- Save changes button-->
